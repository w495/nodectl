...
%% @author Ilya w-495 Nikiti
%% Prev version:    25.04.2009
%%                  Andrew Gopienko
%% @doc Cached log for dual loging (to stdout and file)
%%
...
-define(WRAP_LINES_CHECK, 1000).  %% Every 1000 check size of log
